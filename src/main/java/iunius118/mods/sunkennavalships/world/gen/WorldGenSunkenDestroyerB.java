...
import iunius118.mods.sunkennavalships.world.gen.structure.StructureSunkenDestroyerB.Pieces;
...
public class WorldGenSunkenDestroyerB extends WorldGenSunkenNavalShip
{
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
    {
        ...
        SunkenNavalShips.logger.info("Generate SunkenDestroyer B class between ({}, {}) - ({}, {})", (x1 + dx * 3), (z1 + dz * 3), (x1 + dx * -4), (z1 + dz * -4));
